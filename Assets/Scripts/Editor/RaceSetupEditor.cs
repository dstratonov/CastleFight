...
public static class RaceSetupEditor
{
    ...
    const string BuildingPrefabPath = "Assets/Prefabs/Building.prefab";
    ...
    public static void GenerateAllRaces()
    {
        ...
        {
            Debug.LogError("[RaceSetup] Building.prefab not found at " + BuildingPrefabPath);
            return;
        }
    ...
    {
        string[] dirs = { PrefabDir, UnitDataDir, BuildingDataDir, RaceDataDir, "Assets/Resources" };
    ...
    {
        string path = $"{PrefabDir}/Unit_{def.id}.prefab";
        ...
        {
            Debug.LogWarning($"[RaceSetup] Model not found at {def.modelPath}, creating empty placeholder");
    ...
    static RaceDef DefineHorde()
    {
        return new RaceDef
        {
            ...
            buildings = new[]
            {
                Bld("goblin_hut", "Goblin Hut", "Spawns Goblins", 80, 400, 1, 10f,
                ...
                Bld("kobold_camp", "Kobold Camp", "Spawns Kobolds", 100, 500, 1, 12f,
                ...
                Bld("orc_barracks", "Orc Barracks", "Spawns Orcs", 160, 600, 2, 15f,
                ...
                Bld("troll_den", "Troll Den", "Spawns Trolls", 250, 700, 3, 18f,
                ...
                Bld("cyclops_hall", "Cyclops Hall", "Spawns Cyclops", 380, 800, 3, 22f,
    ...
    static RaceDef DefineUndead()
    {
        return new RaceDef
        {
            ...
            buildings = new[]
            {
                Bld("crypt", "Crypt", "Spawns Ghouls", 80, 400, 1, 10f,
                ...
                Bld("graveyard", "Graveyard", "Spawns Skeleton Knights", 120, 500, 2, 13f,
                ...
                Bld("tomb", "Tomb", "Spawns Mummies", 180, 600, 2, 16f,
                ...
                Bld("blood_sanctum", "Blood Sanctum", "Spawns Vampires", 240, 650, 3, 18f,
                ...
                Bld("necropolis", "Necropolis", "Spawns Undead", 340, 750, 3, 20f,
    ...
    static RaceDef DefineWild()
    {
        return new RaceDef
        {
            ...
            buildings = new[]
            {
                Bld("rat_warren", "Rat Warren", "Spawns Giant Rats", 60, 350, 1, 8f,
                ...
                Bld("snake_pit", "Snake Pit", "Spawns Giant Vipers", 100, 450, 1, 12f,
                ...
                Bld("wolf_den", "Wolf Den", "Spawns Fantasy Wolves", 160, 550, 2, 14f,
                ...
                Bld("spider_lair", "Spider Lair", "Spawns Darkness Spiders", 200, 600, 2, 16f,
                ...
                Bld("ancient_grove", "Ancient Grove", "Spawns Oak Tree Ents", 360, 750, 3, 22f,
    ...
    static RaceDef DefineDragons()
    {
        return new RaceDef
        {
            ...
            buildings = new[]
            {
                Bld("lizard_pit", "Lizard Pit", "Spawns Lizard Warriors", 100, 450, 1, 12f,
                ...
                Bld("hatchery", "Hatchery", "Spawns Dragonides", 170, 550, 2, 15f,
                ...
                Bld("wyvern_roost", "Wyvern Roost", "Spawns Wyverns", 200, 550, 2, 16f,
                ...
                Bld("hydra_pool", "Hydra Pool", "Spawns Hydras", 300, 700, 3, 20f,
                ...
                Bld("dragon_lair", "Dragon Lair", "Spawns Mountain Dragons", 420, 850, 4, 25f,
    ...
    static RaceDef DefineMythical()
    {
        return new RaceDef
        {
            ...
            buildings = new[]
            {
                Bld("werewolf_den", "Werewolf Den", "Spawns Werewolves", 100, 450, 1, 12f,
                ...
                Bld("harpy_aerie", "Harpy Aerie", "Spawns Harpies", 140, 500, 2, 13f,
                ...
                Bld("griffin_roost", "Griffin Roost", "Spawns Griffins", 210, 600, 2, 16f,
                ...
                Bld("manticora_lair", "Manticora Lair", "Spawns Manticoras", 290, 700, 3, 18f,
                ...
                Bld("chimera_sanctum", "Chimera Sanctum", "Spawns Chimeras", 400, 800, 4, 22f,
    ...
    static RaceDef DefineSwarm()
    {
        return new RaceDef
        {
            ...
            buildings = new[]
            {
                Bld("mushroom_patch", "Mushroom Patch", "Spawns Mushrooms", 60, 350, 1, 9f,
                ...
                Bld("hive", "Hive", "Spawns Bees", 90, 400, 1, 10f,
                ...
                Bld("thorn_garden", "Thorn Garden", "Spawns Plant Shooters", 150, 550, 2, 14f,
                ...
                Bld("eye_tower", "Eye Tower", "Spawns Eyeball Monsters", 200, 600, 2, 16f,
                ...
                Bld("dark_sanctum", "Dark Sanctum", "Spawns Dark Wizards", 320, 700, 3, 20f,
    ...
    static BuildingDef Bld(string id, string name, string desc, int cost, int hp, int tier, float interval, UnitDef unit)
    {
